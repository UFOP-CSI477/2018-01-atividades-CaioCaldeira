        ...
        <div class="col-md-12">
            ...
            @if (session('mensagem_edit_error'))
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    ...
                    Id inválido, por favor mude para um id válido para ter acesso a página de edição.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <tbody>
                            @foreach($tests as $e)
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-warning btn-sm btn-block" onclick="window.location='{{ route('test.edit', [ 'id' => $e -> id]) }}'">Editar</button></td>
